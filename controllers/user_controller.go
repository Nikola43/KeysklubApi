...
import (
	...
	"github.com/nikola43/worst_api/models"
	"github.com/nikola43/worst_api/utils"
)
...
func TestRoutine(w http.ResponseWriter, r *http.Request) {

	myPool.Submit(func() {
		user := &models.User{}
		users, err := user.GetNumberOfUsers(con)
		utils.RespondHttpRequest(w, err, users)
	})
}
